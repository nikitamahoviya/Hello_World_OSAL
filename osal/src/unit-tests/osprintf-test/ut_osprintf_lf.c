...
void UT_osprintf_lf(void)
{
    ...
    struct
    {
        ...
        {"05", 123456.2311, 11, "%9.7lf", "123456.2311000",
         "%lf with precision and maximum field size, positive value"},
        ...
        {"12", -123456.7, 14, "%15.4lf", "   -123456.7000",
         "%lf with precision and maximum field size, negative value"},
