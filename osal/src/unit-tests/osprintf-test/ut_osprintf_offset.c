...
unsigned long testPattern[12][10] = {{0x12ab34cd, 0x19999991, 0x18888881, 0x17777771, 0x16666661, 0x15555551,
                                      0x14444441, 0x13333331, 0x12222221, 0x11111111},
                                     {0x23bc45de, 0x29999992, 0x28888882, 0x27777772, 0x26666662, 0x25555552,
                                      0x24444442, 0x23333332, 0x22222222, 0x21111112},
                                     {0x34cd56ef, 0x39999993, 0x38888883, 0x37777773, 0x36666663, 0x35555553,
                                      0x34444443, 0x33333333, 0x32222223, 0x31111113},
                                     {0x45ab67cd, 0x49999994, 0x48888884, 0x47777774, 0x46666664, 0x45555554,
                                      0x44444444, 0x43333334, 0x42222224, 0x41111114},
                                     {0x56bc78de, 0x59999995, 0x58888885, 0x57777775, 0x56666665, 0x55555555,
                                      0x54444445, 0x53333335, 0x52222225, 0x51111115},
                                     {0x67cd78ef, 0x69999996, 0x68888886, 0x67777776, 0x66666666, 0x65555556,
                                      0x64444446, 0x63333336, 0x62222226, 0x61111116},
                                     {0x78ab9acd, 0x79999997, 0x78888887, 0x77777777, 0x76666667, 0x75555557,
                                      0x74444447, 0x73333337, 0x72222227, 0x71111117},
                                     {0x89bcabde, 0x89999998, 0x88888888, 0x87777778, 0x86666668, 0x85555558,
                                      0x84444448, 0x83333338, 0x82222228, 0x81111118},
                                     {0x9acdbcef, 0x99999999, 0x98888889, 0x97777779, 0x96666669, 0x95555559,
                                      0x94444449, 0x93333339, 0x92222229, 0x91111119},
                                     {0xababcdcd, 0xa999999a, 0xa888888a, 0xa777777a, 0xa666666a, 0xa555555a,
                                      0xa444444a, 0xa333333a, 0xa222222a, 0xa111111a},
                                     {0xbcbcdede, 0xb999999b, 0xb888888b, 0xb777777b, 0xb666666b, 0xb555555b,
                                      0xb444444b, 0xb333333b, 0xb222222b, 0xb111111b},
                                     {0xcdcdefef, 0xc999999c, 0xc888888c, 0xc777777c, 0xc666666c, 0xc555555c,
                                      0xc444444c, 0xc333333c, 0xc222222c, 0xc111111c}};
...
void UT_osprintf_CalcOffsets(void)
{
    ...
    CalcOffset_CFE_ES_WriteToSysLog("CFE_ES_WriteToSysLog test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld",
                                    testPattern[0][0], testPattern[0][1], testPattern[0][2], testPattern[0][3],
                                    testPattern[0][4], testPattern[0][5], testPattern[0][6], testPattern[0][7],
                                    testPattern[0][8], testPattern[0][9]);
    CalcOffset_EVS_SendEvent(111, 222, "EVS_SendEvent test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[1][0],
                             testPattern[1][1], testPattern[1][2], testPattern[1][3], testPattern[1][4],
                             testPattern[1][5], testPattern[1][6], testPattern[1][7], testPattern[1][8],
                             testPattern[1][9]);
    CalcOffset_CFE_EVS_SendEvent(333, 444, "CFE_EVS_SendEvent test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld",
                                 testPattern[2][0], testPattern[2][1], testPattern[2][2], testPattern[2][3],
                                 testPattern[2][4], testPattern[2][5], testPattern[2][6], testPattern[2][7],
                                 testPattern[2][8], testPattern[2][9]);
    CalcOffset_CFE_EVS_SendEventWithAppID(
        555, 666, 7, "CFE_EVS_SendEventWithAppID test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[3][0],
        testPattern[3][1], testPattern[3][2], testPattern[3][3], testPattern[3][4], testPattern[3][5],
        testPattern[3][6], testPattern[3][7], testPattern[3][8], testPattern[3][9]);
    CalcOffset_CFE_EVS_SendTimedEvent(
        Time, 888, 999, "CFE_EVS_SendTimedEvent test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[4][0],
        testPattern[4][1], testPattern[4][2], testPattern[4][3], testPattern[4][4], testPattern[4][5],
        testPattern[4][6], testPattern[4][7], testPattern[4][8], testPattern[4][9]);
    CalcOffset_OS_printf("OS_printf test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[5][0], testPattern[5][1],
                         testPattern[5][2], testPattern[5][3], testPattern[5][4], testPattern[5][5], testPattern[5][6],
                         testPattern[5][7], testPattern[5][8], testPattern[5][9]);
    CalcOffset_OS_sprintf(cMsg, "OS_sprintf test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[6][0],
                          testPattern[6][1], testPattern[6][2], testPattern[6][3], testPattern[6][4], testPattern[6][5],
                          testPattern[6][6], testPattern[6][7], testPattern[6][8], testPattern[6][9]);
    CalcOffset_OS_snprintf(cMsg, 100, "OS_snprintf test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[7][0],
                           testPattern[7][1], testPattern[7][2], testPattern[7][3], testPattern[7][4],
                           testPattern[7][5], testPattern[7][6], testPattern[7][7], testPattern[7][8],
                           testPattern[7][9]);
    CalcOffset_OS_printf_stub("OS_printf stub test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[8][0],
                              testPattern[8][1], testPattern[8][2], testPattern[8][3], testPattern[8][4],
                              testPattern[8][5], testPattern[8][6], testPattern[8][7], testPattern[8][8],
                              testPattern[8][9]);
    CalcOffset_CFE_ES_WriteToSysLog_stub("CFE_ES_WriteToSysLog stub test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld",
                                         testPattern[9][0], testPattern[9][1], testPattern[9][2], testPattern[9][3],
                                         testPattern[9][4], testPattern[9][5], testPattern[9][6], testPattern[9][7],
                                         testPattern[9][8], testPattern[9][9]);
    CalcOffset_CFE_EVS_SendEvent_stub(333, 444, "CFE_EVS_SendEvent stub test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld",
                                      testPattern[10][0], testPattern[10][1], testPattern[10][2], testPattern[10][3],
                                      testPattern[10][4], testPattern[10][5], testPattern[10][6], testPattern[10][7],
                                      testPattern[10][8], testPattern[10][9]);
    CalcOffset_CFE_EVS_SendEventWithAppID_stub(
        555, 666, 5, "CFE_EVS_SendEventWithAppID stub test %ld %ld %ld %ld %ld %ld %ld %ld %ld %ld", testPattern[11][0],
        testPattern[11][1], testPattern[11][2], testPattern[11][3], testPattern[11][4], testPattern[11][5],
        testPattern[11][6], testPattern[11][7], testPattern[11][8], testPattern[11][9]);
}
...
int32 CalcOffset_EVS_SendEvent(uint16 EventID, uint16 EventType, const char *Spec, ...)
{
...
int32 CalcOffset_CFE_EVS_SendEvent(uint16 EventID, uint16 EventType, const char *Spec, ...)
{
    CFE_EVS_Packet_t   EVS_Packet;
    uint32             AppID = 0;
    CFE_TIME_SysTime_t Time  = {0, 0};
...
int32 CalcOffset_CFE_EVS_SendEventWithAppID(uint16 EventID, uint16 EventType, uint32 AppID, const char *Spec, ...)
{
    CFE_EVS_Packet_t   EVS_Packet;
    CFE_TIME_SysTime_t Time = {0, 0};
    va_list            Ptr;
...
int32 CalcOffset_CFE_EVS_SendTimedEvent(CFE_TIME_SysTime_t Time, uint16 EventID, uint16 EventType, const char *Spec,
                                        ...)
{
    CFE_EVS_Packet_t EVS_Packet;
    uint32           AppID = 0;
...
int32 CalcOffset_CFE_EVS_SendEvent_stub(uint16 EventID, uint16 EventType, const char *Spec, ...)
{
...
int32 CalcOffset_CFE_EVS_SendEventWithAppID_stub(uint16 EventID, uint16 EventType, uint32 AppID, const char *Spec, ...)
{
    char    BigBuf[CFE_EVS_MAX_MESSAGE_LENGTH];
    va_list Ptr;
    ...
    OS_vsnprintfDummy(BigBuf, CFE_EVS_MAX_MESSAGE_LENGTH, Spec, Ptr);
    UT_AddEventToHistoryDummy(EventID);
    OS_snprintfDummy(cMsg, UT_MAX_MESSAGE_LENGTH, "  CFE_EVS_SendEvent from app %lu: %u, %u - %s", AppID, EventID,
                     EventType, BigBuf);
