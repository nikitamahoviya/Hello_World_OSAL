...
int32              CalcOffset_EVS_SendEvent(uint16, uint16, const char *, ...);
int32              CalcOffset_CFE_EVS_SendEvent(uint16, uint16, const char *, ...);
int32              CalcOffset_CFE_EVS_SendEventWithAppID(uint16, uint16, uint32, const char *, ...);
int32              CalcOffset_CFE_EVS_SendTimedEvent(CFE_TIME_SysTime_t, uint16, uint16, const char *, ...);
...
int32              CalcOffset_CFE_EVS_SendEvent_stub(uint16, uint16, const char *, ...);
int32              CalcOffset_CFE_EVS_SendEventWithAppID_stub(uint16, uint16, uint32, const char *, ...);
void               CFE_TIME_PrintDummy(char *, CFE_TIME_SysTime_t);
unsigned char      EVS_IsFilteredDummy(uint32, uint16, uint16);
void               CFE_SB_InitMsgDummy(void *, uint16, uint16, unsigned char);
CFE_TIME_SysTime_t CFE_TIME_GetTimeDummy(void);
void               EVS_SendPacketDummy(uint32, CFE_TIME_SysTime_t, CFE_EVS_Packet_t *);
